command :'create host' do |c|
  ...
  c.example "Create the host example.com in your DigitalOcean console. This is described in '#{DigitalOcean::OPS_DIR}/hosts/example.com' like:\n    #      size:     512mb\n    #      region:   ams1\n    #      image:    coreos-stable\n    #      ssh_keys:\n    #        - e7:51:47:bc:7f:dc:2f:3c:56:65:28:e1:10:9c:88:57  xx:xx:xx:xx:xx:xx:xx", 'ops create domain example.com'
